%% BIHARMDIAG Biharmonic Diagonal coefficients
...
%  - nu  : Poisson's ratio
%  - dia : Index of diagonal valid_diags = ['-2ny',... 
%    '-ny-1', '-ny', '-ny+1',...
%    '-2', '-1', '0', '1', '2', ...
%    'ny-1', 'ny', 'ny+1',...
%    '2ny']
...
validateattributes(dia,      {'double'}, {'nonempty'});
...
dia = validatestring    (dia,    valid_diags);
