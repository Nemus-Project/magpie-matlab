...
Direct modelling can be run in both the frequency and the time domains. For the frequency domain, the simulation parameters are specified in the FreqDomainLauncher.m [a link](https://github.com/Nemus-Project/magpie-matlab/blob/b9f2f20d2ebe36d25f70e85deda9e8486661e0a5/orthotropic/src/FreqDomainLauncher.m)
