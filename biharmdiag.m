...
switch dia
    ...
    case '-ny'
        ...
        d0 = [NaN; NaN; NaN; NaN;];
        dc = [D21u10; D22u11; D2Nm1u1Nm2; D2Nu1Nm1];
        dM1 = [D10u20;D11u21;D12u22,D1Nu2N;D1Nm1u2Nm1];
        dM = [D01u10; D02u11; D0Nm1u1Nm2; D0Nu1Nm1];
    ...
    case '-2'
        ...
        [~,~,~,~,~, ND1Nu1Nm2,~,~] = D10_coeffs(RLy,KxL,RxL,h,D,nu,5);
        ...
        dc = [D22u20;D2Nu2Nm2;D2Nm1u2Nm3];        
        dM1 = [DN12u10;DN1Nu1Nm2;DN1Nm1u1Nm3];
    ...
    case '-1'
        ...
        d0  = [D01u00;D02u01;D0Nu0Nm1;D0Nm1u0Nm2];
    ...
    case '1'
        ...
        [~,~,~,~, D10u11,~,~,~] = D10_coeffs(RLy,Kx0,Rx0,h,D,nu,4);
        [~,D11u12,~,~,~,~,~,~,~,~,~] = D11_coeffs(RLy,Rx0,h,D,nu,1);
        [~,D12u13,~,~,~,~,~,~,~,~,~,~] = D12_coeffs(RLy,h,D,nu,1);
        [~,~,~,~,~,~,~,~] = D10_coeffs(RLy,KxL,RxL,h,D,nu);
        [~,~,~,D1Nm1u1N,~,~,~,~,~,~,~] = D11_coeffs(RLy,RxL,h,D,nu,3);

        [~,~,~,D00u01,~,~] = D00_coeffs(KLy,RLy,Kx0,Rx0,h,D,nu,3);
        [~,~,~,~,D01u02,~,~,~] = D01_coeffs(KLy,RLy,Rx0,h,D,nu,4);
        [~,~,~,~,D02u03,~,~,~,~] = D02_coeffs(KLy,RLy,h,D,nu,4);
        [~,~,~,~,~,~] = D00_coeffs(KLy,RLy,KxL,RxL,h,D,nu);
        [~,~,~,D0Nm1u0N,~,~,~,~] = D01_coeffs(KLy,RLy,RxL,h,D,nu,3);

        d0  = [D02u01;D0Nu0Nm1;D0Nm1u0Nm2;D0Nm1u0N];
        d1  = [D11u10;D12u11;D1Nm1u1Nm2;D1Nu1Nm1];
        dc  = [D21u20;D22u21;D2Nm1u2Nm2;D2Nu2Nm1];
        dM1 = [DN11u10;DN12u11;DN1Nm1u1Nm2;DN1Nu1Nm1];
        dM  = [DN1u00;DN2u01;DNNm1u0Nm2;DNNu0Nm1];
    ...
    case 'ny-1'
        ...
        dM1 =[DN11u00;DN12u01;DN1Nu0Nm1;DN1Nm1u0Nm2];
        dM = [NaN; NaN; NaN; NaN;];
    ...
    case 'ny'
        ...
        d0 = [D00u10;D01u11;D02u12;D0Nu1N;D0Nm1u1Nm1];    
        d1 = [D10u20;D11u21;D12u22;D1Nu2N;D1Nm1u2Nm1];        
        dc = [D20u30;D21u31;D22u32;D2Nu3N;D2Nm1u3Nm1];
        dM1 = [DN10u00;DN11u01;DN12u02;DN1Nu0N;DN1Nm1u0Nm1];
    ...
    case 'ny+1'
        ...
        [~,~,~,~,~,~,~,D20u31,~] = D20_coeffs(Kx0,Rx0,h,D,nu,8);
        [~,~,~,~,~,~,~,~,D21u32,~,~,~] = D21_coeffs(Rx0,h,D,nu);
        [~,~,~,~,~,~,~,~,~,~,~,D22u33,~] = D22_coeffs;
        [~,~,~,~,~,~,~,~,~,D2Nm1u3N,~,~] = D21_coeffs(RxL,h,D,nu);
        [~,~,~,~,~,~,~,~,~] = D20_coeffs(KxL,RxL,h,D,nu);

        [~,~,~,~,~,~,~, DN10u01] = D10_coeffs(RLy,Kx0,Rx0,h,D,nu,5);
        ...
        d2 =[D20u31;D21u32;D22u33;D2Nm1u3N];
    ...
    case '2ny'
        ...
        d0 = [D00u20;D01u21;D02u22;D0Nu2N;D0Nm1u2Nm1];        
        d1 = [D10u30;D11u31;D12u32;D1Nu3N;D1Nm1u3Nm1];
